...
describe('resolveApiConfig', () => {
  ...
  it('prioriza TRCON_LEADS_API_URL sobre o legado waitlist', () => {
    const cfg = resolveApiConfig({
      TRCON_LEADS_API_URL: 'https://api-site.trcongroup.com.br/api/v1/site/leads',
      TRCON_WAITLIST_API_URL: 'https://legado/waitlist',
    });
    expect(cfg.leadsApiUrl).toBe('https://api-site.trcongroup.com.br/api/v1/site/leads');
  });
  ...
  it('propaga URLs de highlights e news quando injetadas', () => {
    const cfg = resolveApiConfig({
      TRCON_HIGHLIGHTS_API_URL: 'https://api-site.trcongroup.com.br/api/public/highlights',
      TRCON_NEWS_API_URL: 'https://api-site.trcongroup.com.br/api/public/news',
    });
    expect(cfg.highlightsApiUrl).toBe('https://api-site.trcongroup.com.br/api/public/highlights');
    expect(cfg.newsApiUrl).toBe('https://api-site.trcongroup.com.br/api/public/news');
  });
});
